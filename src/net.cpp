...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Badgercoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"node1.badgercoin.info", "node1.badgercoin.info"},
    {"node2.badgercoin.info", "node2.badgercoin.info"},
    {"node3.badgercoin.info", "node3.badgercoin.info"},
    {"node4.badgercoin.info", "node4.badgercoin.info"},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Badgercoin is probably already running."), addrBind.ToString().c_str());
        else
